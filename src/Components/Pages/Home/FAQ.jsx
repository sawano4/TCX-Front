...
function FAQElement(props) {
  ...
  return (
    <div
      className={`${
        !isOpen
          ? "px-[4vw] border-2 py-[3vh] border-[#0077B6] rounded-[8px] flex flex-col gap-[2vh] transition duration-700 border-[#0077B6] text-[#202020]"
          : "px-[4vw] border-2 py-[4vh] border-[#0077B6] rounded-[8px] flex flex-col gap-[2vh] bg-[#0077B6] text-white shadow-[0_35px_60px_15px_rgba(43, 45, 66, 1)] transition duration-700"
      }`}
    >
      <button
        onClick={toggleOpen}
...
function FAQ() {
  return (
    <div className="flex w-full flex-col gap-[4vh] items-center">
      <h1 className="font-regular text-[#202020] md:text-[4rem] text-[2rem] text-center">
